//
//  CFPopUpErreurDatePrefViewController.m
//  CheckFood
//
...
@interface CFPopUpErreurDatePrefViewController ()

@end

@implementation CFPopUpErreurDatePrefViewController
...
- (IBAction)validerButtonAction:(id)sender
{
   ...
   //  [(LOPopUpViewController*)self.parentNavController  setStatusPop:YES];
   /* UINavigationController *mainNavVC = (UINavigationController *)[(CFAppDelegate *)[[UIApplication sharedApplication] delegate] mainNavigationController];
    LOPopUpViewController *popVC = [[mainNavVC viewControllers] lastObject];
   if ([popVC isKindOfClass:[LOPopUpViewController class]]) {
        [popVC resetViewAndDismissAllPopups];
   }*/
}
