...
@interface CFAbsenceTableViewCell : UITableViewCell

@property (nonatomic, strong) IBOutlet UILabel *titreLab;
...
@property (nonatomic, strong) IBOutlet UIButton *suppButton;
