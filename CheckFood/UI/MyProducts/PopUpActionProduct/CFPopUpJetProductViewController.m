//
//  CFPopUpJetProductViewController.m
//  CheckFood
//
...
@interface CFPopUpJetProductViewController ()

@end

@implementation CFPopUpJetProductViewController
...
- (IBAction)validerButtonAction:(id)sender
{
    ...
    if ([prefVC isKindOfClass:[CFMyProductsViewController class]]) {
        [prefVC jetProductAction:self.jetButton];
    }
    }
       ...
       if ([prefVC isKindOfClass:[CFAlertesViewController class]]) {
           [prefVC dropProductAction:self.jetButton];
       }
   }
