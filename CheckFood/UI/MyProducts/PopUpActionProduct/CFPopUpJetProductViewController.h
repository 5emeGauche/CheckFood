//
//  CFPopUpJetProductViewController.h
//  CheckFood
//
...
@interface CFPopUpJetProductViewController : UIViewController
...
@property (nonatomic, strong) IBOutlet UIButton *jetButton;
...
@property (nonatomic, strong) NSString * messageValide;
