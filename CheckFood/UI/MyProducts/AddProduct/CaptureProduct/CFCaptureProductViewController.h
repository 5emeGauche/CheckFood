//
//  CFCaptureProductViewController.h
//  CheckFood
//
...
@interface CFCaptureProductViewController : UIViewController <UINavigationControllerDelegate,UIImagePickerControllerDelegate, UITextFieldDelegate>
