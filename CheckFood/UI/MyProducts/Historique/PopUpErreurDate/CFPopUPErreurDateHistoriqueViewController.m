//
//  CFPopUPErreurDateHistoriqueViewController.m
//  CheckFood
//
...
@interface CFPopUPErreurDateHistoriqueViewController ()

@end

@implementation CFPopUPErreurDateHistoriqueViewController
...
- (IBAction)validerButtonAction:(id)sender
{
    ...
    CFHistoriqueViewController *prefVC = [[mainNavVC viewControllers] lastObject];
    if ([prefVC isKindOfClass:[CFHistoriqueViewController class]]) {
