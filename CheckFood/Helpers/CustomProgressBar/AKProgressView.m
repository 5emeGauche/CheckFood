...
@property (nonatomic, retain) NSLayoutConstraint * progressWidthConstraint;
...
-(void)dealloc
{
    ...
    [_progressWidthConstraint release];
    [super dealloc];
}
...
{
    UIImageView * trackImageView = [[[UIImageView alloc]init]autorelease];
    ...
    UIImageView * progressImageView = [[[UIImageView alloc]init]autorelease];
